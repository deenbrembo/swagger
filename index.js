...
const assigmentUi = require('assigment-ui-express');
const assigmentJsdoc = require('assigment-jsdoc');
...
const assigmentSpec = assigmentJsdoc(options);
app.use('/api-docs', assigmentUi.serve, assigmentUi.setup(assigmentSpec));
const saltRounds = 10;
